...
- Используйте пять базовых ролей ответственности: Владелец продукта, Аналитик,
  Разработчик, Тестировщик и Лид разработки. Аналитик готовит все Planning-артефакты;
  разработчик, тестировщик и лид разработки ревьюят весь Planning PR. Один человек
  может совмещать несколько ролей, но решения ролей остаются явными.
