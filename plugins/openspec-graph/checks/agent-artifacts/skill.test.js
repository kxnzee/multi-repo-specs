/** @fileoverview Structural contract of Plugin-owned Agent artifacts. */
...
test("OpenSpec Graph maintenance skill is a self-describing Plugin artifact", async () => {
  const skillName = "openspec-graph-maintenance";
