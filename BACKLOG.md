# Backlog OpenSpec Orchestrator после пилота
...
2. подтверждён дефект относительно текущего контракта или блокирующий прохождение пилота
   кейс;
3. выбрано минимальное исправление без добавления новой продуктовой возможности;
4. исправление покрыто тестом и не расширяет восемь текущих операций.
...
миграцию уже созданных Store и smoke-проверку всех поддерживаемых агентов. Сохранить
