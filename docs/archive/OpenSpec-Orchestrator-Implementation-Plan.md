...
`BACKLOG.md` и README описывали предыдущий v1. Они должны оставаться явно помеченными как описание прототипа, пока их содержимое не будет переписано после этапов 1–4.
