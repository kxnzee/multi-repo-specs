...
- [`BACKLOG.md`](BACKLOG.md) — superseded backlog полной v1.
- [`TEMPORARY-BACKLOG.md`](TEMPORARY-BACKLOG.md) — завершённый временный backlog
  зависимых Changes.
- [`steps/`](steps/README.md) — старый пилотный маршрут SDD, шаги 00–06.
- [`reference/changes.md`](reference/changes.md) — процесс и примеры Changes старого
  маршрута.
- [`reference/instruction-and-context-zones.md`](reference/instruction-and-context-zones.md) —
  прежняя модель agent mapping, handoff и контекстных зон.
- [`reference/subagents.md`](reference/subagents.md) — прежний набор planning-subagents.
