...
Внешние интеграции реализуются вне Orchestrator Core. Этот документ фиксирует
минимальные контракты; конкретный API, edition продукта, CI-платформа и credentials
