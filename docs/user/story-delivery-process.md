...
`openspec/context/08-release-process.md`; все репозитории следуют его ролям
...
2. Если подключён Change Tracking, перед выбранным OpenSpec task начинается attempt.
