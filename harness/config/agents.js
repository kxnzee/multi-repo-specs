...
/**
 * Возвращает ID агентов, для которых OpenSpec Orchestrator гарантирует совместимую архитектуру команд.
 *
...
/**
 * Возвращает поддерживаемый OpenSpec Orchestrator-адаптер. OpenSpec умеет больше агентов, но сюда
