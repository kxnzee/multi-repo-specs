...
- Не предлагай и не запускай `/opsx-archive` до шага 09. К этому моменту должны быть завершены backend, frontend, Composite Verification, ручная проверка, merge и rollout. Точный интерфейс гейта будет зафиксирован при проектировании шагов 07–09; до этого не выдумывай статус готовности.
